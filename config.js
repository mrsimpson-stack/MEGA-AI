...
const defaultOwner = '256764803976';


// Check for the OWNERS environment variable; if not found, use the default
const ownervb = process.env.OWNERS || process.env.OWNER_NUMBER || '256764803976' ; // put your number here
...
global.pairingNumber = process.env.BOT_NUMBER || '256764803976' ;  // put your number here
